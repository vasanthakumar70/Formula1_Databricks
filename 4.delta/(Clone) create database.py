...
# MAGIC OPTIONS (
# MAGIC     header "true",
# MAGIC     path 'abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/circuits.csv'
# MAGIC )
...
# MAGIC url STRING)
# MAGIC USING csv
# MAGIC OPTIONS (path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/races.csv", header true)
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/constructors.json")
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS (path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/drivers.json")
...
# MAGIC USING json
# MAGIC OPTIONS(path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/results.json")
...
# MAGIC time STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/pit_stops.json", multiLine true)
...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/lap_times")
...
# MAGIC raceId INT)
# MAGIC USING json
# MAGIC OPTIONS (path "abfss://incrementalload@vasanthblob.dfs.core.windows.net/raw/${filename}/qualifying", multiLine true)
