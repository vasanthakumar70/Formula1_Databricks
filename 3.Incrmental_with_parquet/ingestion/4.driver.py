...
if source_point=="adls":
    ...
    driver_with_date.write.format("parquet").mode("overwrite")\
        .option("path", f"abfss://{container_name}@vasanthblob.dfs.core.windows.net/processed/drivers")\
            .saveAsTable(f"{process_database}.driver")
