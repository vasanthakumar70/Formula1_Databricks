...
if source_point=="adls":
    ...
    race_with_date.write.mode("overwrite").format("parquet")\
        .option("path", f"abfss://{container_name}@vasanthblob.dfs.core.windows.net/processed/races")\
        .saveAsTable(f"{process_database}.race")

# COMMAND ----------

# MAGIC %sql
# MAGIC select * from par_f1_processed_inc.race
